...
class GenerateDeRPNLabelsTargetsLayer(nn.Module):

    # def __init__(self,bottom):
    def __init__(self, feat_stride):

        super(GenerateDeRPNLabelsTargetsLayer, self).__init__()
    ...
    def  determine_gts(self ,gt_boxes):
        ...
        keep = np.where((gtw>self.min_gt_size) & (gth>self.min_gt_size))[0]  # self.min_gt_size = 1
